...
OUT_PATH = OUT_DIR / "19组-程晓洋-项目立项.docx"
...
def build():
    ...
    add_table(
        ...
        ["成员", "角色", "职责"],
        [
            ("程晓洋", "组长/项目经理、数据库管理员、主力程序员", "负责项目统筹、数据库设计、M2/M7/M8/M13/M16/M17数据运营与监管模块和文档汇总。"),
            ("丁梓钊", "产品经理、主力程序员、测试工程师", "负责产品原型、M1/M9/M10/M11/M12/M14车主端与扩展场景和测试用例设计。"),
            ("程子浩", "主力程序员、需求分析师、QA", "负责需求分析、M3/M4/M5/M6/M15/M18车主停车路径与营销闭环、接口联调和文档校对。"),
        ],
        [1500, 3100, 5000],
    )
